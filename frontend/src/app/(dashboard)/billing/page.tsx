...
import { Plus, Printer, Trash2, IndianRupee, CreditCard, Wallet, CalendarDays, Search, Download, CheckCircle2, ChevronRight, Receipt, FileText, ImageIcon } from 'lucide-react';
          ...
          <div className="space-y-4 text-xs">
            ...
            <div>
              ...
              <SearchableSelect 
                ...
                options={[
                  ...MASTER_DENTAL_TREATMENTS.map(p => ({ value: p.name, label: p.name })),
                  { value: "Custom Treatment Procedure", label: "Custom Treatment Procedure" }
                ]}
              />
            </div>
            ...
            <div className="border-t border-slate-100 pt-4 space-y-3">
              ...
              <div>
                ...
                <SearchableSelect 
                  ...
                  className="w-full bg-[#FAF6FB] border border-slate-200 rounded-xl p-2.5 font-bold outline-none focus:border-[#73308A]"
                  options={[
                    { value: "UPI / QR", label: "UPI (GPay / PhonePe / Paytm)" },
