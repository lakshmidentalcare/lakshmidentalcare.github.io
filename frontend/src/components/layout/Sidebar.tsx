...
const navigation = [
  ...
  { name: 'Clinical & Charting', href: '/clinical', icon: Activity },
  { name: 'Treatment Plans', href: '/treatment-plans', icon: GitPullRequest },
  ...
  { name: 'Users & Access', href: '/settings?tab=users', icon: ShieldCheck },
